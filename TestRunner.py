...
def main_aborgardt_bWAPP():
    filelist = glob.glob("./config/targets/aborgardt.bwapp/*.json")
    runconfigPath = "aborgardt.bwapp/"
    rounds = 25
    generators = ["smarty", "dharma"]
    runtests = ['', '--enableWebdriver']
...
if __name__ == "__main__":
    sys.exit(main_aborgardt_badWAF())
